...
Purpose: This program is a GUI based desktop application for maintaining client appointments. It interfaces with a
MySQL database hosted on AWS and allows the user to create, edit, modify and delete both clients and appointments from
the database.
...
Both types of users are able to create, edit, modify and delete appointments and Admin users are able to additionally create
new users for the application.
